...
// src/padkap/methods/custom/getConfigSections.ts
async function getConfigSections() {
  return uci.load("padkap").then(() => uci.sections("padkap"));
}

// src/padkap/methods/shell/callBaseMethod.ts
async function callBaseMethod(method, args = [], command = "/usr/bin/padkap") {
...
((Padkap2) => {
  ...
  })(AvailableMethods = Padkap2.AvailableMethods || (Padkap2.AvailableMethods = {}));
  ...
  })(AvailableClashAPIMethods = Padkap2.AvailableClashAPIMethods || (Padkap2.AvailableClashAPIMethods = {}));
})(Padkap || (Padkap = {}));

// src/padkap/methods/shell/index.ts
var PadkapShellMethods = {
  ...
  getStatus: async () => callBaseMethod(Padkap.AvailableMethods.GET_STATUS),
  ...
  getClashApiProxies: async () => callBaseMethod(Padkap.AvailableMethods.CLASH_API, [
  ...
  setClashApiGroupProxy: async (group, proxy) => callBaseMethod(Padkap.AvailableMethods.CLASH_API, [
  ...
  globalCheck: async () => callBaseMethod(Padkap.AvailableMethods.GLOBAL_CHECK),
  showSingBoxConfig: async () => callBaseMethod(Padkap.AvailableMethods.SHOW_SING_BOX_CONFIG),
  checkLogs: async () => callBaseMethod(Padkap.AvailableMethods.CHECK_LOGS),
  getSystemInfo: async () => callBaseMethod(
    Padkap.AvailableMethods.GET_SYSTEM_INFO
  ),
  subscriptionUpdate: async () => callBaseMethod(Padkap.AvailableMethods.SUBSCRIPTION_UPDATE)
};

// src/padkap/methods/custom/getDashboardSections.ts
...
// src/padkap/methods/custom/getClashApiSecret.ts
...
// src/padkap/methods/custom/index.ts
var CustomPadkapMethods = {
  getConfigSections,
...
var PADKAP_LUCI_APP_VERSION = "__COMPILED_VERSION_VARIABLE__";
var FAKEIP_CHECK_DOMAIN = "fakeip-check.invalid";
var IP_CHECK_DOMAIN = "proxy-check.invalid";
...
// src/padkap/methods/fakeip/getFakeIpCheck.ts
...
// src/padkap/methods/fakeip/getIpCheck.ts
...
// src/padkap/methods/fakeip/index.ts
var RemoteFakeIPMethods = {
  getFakeIpCheck,
  getIpCheck
};

// src/padkap/services/tab.service.ts
...
// src/padkap/tabs/diagnostic/helpers/getCheckTitle.ts
function getCheckTitle(name) {
  return `${name} ${_("checks")}`;
}

// src/padkap/tabs/diagnostic/checks/contstants.ts
...
// src/padkap/tabs/diagnostic/diagnostic.store.ts
...
// src/padkap/services/store.service.ts
...
// src/padkap/services/logger.service.ts
var Logger = class {
  constructor() {
    this.logs = [];
...
// src/padkap/services/padkapLogWatcher.service.ts
var PadkapLogWatcher = class _PadkapLogWatcher {
  constructor() {
    this.intervalMs = 5e3;
  ...
  static getInstance() {
    if (!_PadkapLogWatcher.instance) {
      _PadkapLogWatcher.instance = new _PadkapLogWatcher();
    }
    return _PadkapLogWatcher.instance;
  }
...
// src/padkap/services/core.service.ts
...
// src/padkap/services/socket.service.ts
...
// src/padkap/tabs/dashboard/partials/renderSections.ts
...
// src/padkap/tabs/dashboard/partials/renderWidget.ts
...
// src/padkap/tabs/dashboard/render.ts
function render() {
  return E(
    "div",
    {
...
// src/padkap/fetchers/fetchServicesInfo.ts
...
// src/padkap/tabs/dashboard/initController.ts
...
async function renderServicesInfoWidget() {
  ...
  const renderedWidget = renderWidget({
    ...
    items: [
      {
        key: _("Padkap"),
        value: servicesInfoWidget.data.padkap ? _("\u2714 Enabled") : _("\u2718 Disabled"),
        attributes: {
          class: servicesInfoWidget.data.padkap ? "pdk_dashboard-page__widgets-section__item__row--success" : "pdk_dashboard-page__widgets-section__item__row--error"
        }
      },
      {
        key: _("Sing-box"),
...
// src/padkap/tabs/dashboard/styles.ts
var styles = `
...
// src/padkap/tabs/dashboard/index.ts
var DashboardTab = {
  render,
  initController,
  styles
...
// src/padkap/tabs/diagnostic/renderDiagnostic.ts
function render2() {
...
// src/padkap/tabs/diagnostic/checks/updateCheckStore.ts
...
// src/padkap/tabs/diagnostic/helpers/getMeta.ts
...
// src/padkap/tabs/diagnostic/checks/runDnsCheck.ts
...
// src/padkap/tabs/diagnostic/checks/runSingBoxCheck.ts
...
// src/padkap/tabs/diagnostic/checks/runNftCheck.ts
...
// src/padkap/tabs/diagnostic/checks/runFakeIPCheck.ts
...
// src/padkap/tabs/diagnostic/partials/renderAvailableActions.ts
...
// src/padkap/tabs/diagnostic/partials/renderCheckSection.ts
...
// src/padkap/tabs/diagnostic/partials/renderRunAction.ts
...
// src/padkap/tabs/diagnostic/partials/renderSystemInfo.ts
...
// src/padkap/tabs/diagnostic/partials/renderWikiDisclaimer.ts
...
// src/padkap/tabs/diagnostic/checks/runSectionsCheck.ts
...
// src/padkap/tabs/diagnostic/initController.ts
...
function renderDiagnosticSystemInfoWidget() {
  ...
  function getPadkapVersionRow() {
    const loading = diagnosticsSystemInfo.loading;
    const unknown = diagnosticsSystemInfo.padkap_version === _("unknown");
    const hasActualVersion = Boolean(diagnosticsSystemInfo.padkap_latest_version) && diagnosticsSystemInfo.padkap_latest_version !== "unknown";
...
// src/padkap/tabs/diagnostic/styles.ts
var styles4 = `
...
// src/padkap/tabs/diagnostic/index.ts
var DiagnosticTab = {
  render: render2,
