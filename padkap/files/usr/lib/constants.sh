...
## Common
PADKAP_CONFIG="/etc/config/padkap"
PADKAP_STATE_DIR="/etc/padkap"
RESOLV_CONF="/etc/resolv.conf"
DNS_RESOLVERS="1.1.1.1 1.0.0.1 8.8.8.8 8.8.4.4 9.9.9.9 9.9.9.11 94.140.14.14 94.140.15.15 208.67.220.220 208.67.222.222 77.88.8.1 77.88.8.8"
CHECK_PROXY_IP_DOMAIN="proxy-check.invalid"
FAKEIP_TEST_DOMAIN="fakeip-check.invalid"
...
SUBSCRIPTION_CACHE_FOLDER="$PADKAP_STATE_DIR/subscriptions"
...
RT_TABLE_NAME="padkap"

## nft
NFT_TABLE_NAME="PadkapTable"
