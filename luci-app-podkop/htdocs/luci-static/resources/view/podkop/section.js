...
function createSectionContent(section) {
  ...
  o = section.option(
    form.Value,
    "subscription_blocked_countries",
    _("Заблокированные страны"),
    _("Список стран для блокировки серверов (через пробел или запятую). Поддерживаются флаги emoji (🇷🇺 🇨🇳) или ISO коды (RU CN)"),
  );
  o.placeholder = "RU CN";
  o.rmempty = true;
  o.depends({ connection_type: "proxy", proxy_config_type: "subscription" });
