...
export const PADKAP_LUCI_APP_VERSION = '__COMPILED_VERSION_VARIABLE__';
export const FAKEIP_CHECK_DOMAIN = 'fakeip-check.invalid';
export const IP_CHECK_DOMAIN = 'proxy-check.invalid';
