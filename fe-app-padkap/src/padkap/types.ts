...
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace Padkap {
  // Available commands:
  // start                   Start padkap service
  // stop                    Stop padkap service
  // reload                  Reload padkap configuration
  // restart                 Restart padkap service
  // enable                  Enable padkap autostart
  // disable                 Disable padkap autostart
  // main                    Run main padkap process
  ...
  // check_logs              Show padkap logs from system journal
  ...
  // show_config             Display current padkap configuration
  // show_version            Show padkap version
  // show_sing_box_config    Show sing-box configuration
  // show_sing_box_version   Show sing-box version
  // show_system_info        Show system information
  // get_status              Get padkap service status
  ...
  export interface GetSystemInfo {
    padkap_version: string;
    padkap_latest_version: string;
